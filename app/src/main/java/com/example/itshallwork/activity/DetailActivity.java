package com.example.itshallwork.activity;
...
import com.example.itshallwork.db.MovieHelper;
import com.example.itshallwork.db.TvHelper;
...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView txtDetailVote = findViewById(R.id.txt_detail_vote);
        ...
        txtDetailVote.setText(String.valueOf(vote));
